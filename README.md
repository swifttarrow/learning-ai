...
2. Create /learn route + lesson generator endpoint

3. Seed concept library
...
7. Build RSS ingestion job

8. Add summarization step

9. Render news feed

10. Polish UX (streaming, caching, search)